...
;(function(window, undefined) {
   ...
   * @param- {Array} [stackA=[]] Internally used to track charterd source objects.
  ...
  function clone(value, deep, guard, stackA, stackB) {
    ...
    // add the source value to the stack of charterd objects
   ...
   * @param- {Object} [stackA=[]] Internally used track charterd `a` objects.
   * @param- {Object} [stackB=[]] Internally used track charterd `b` objects.
  ...
  function isEqual(a, b, stackA, stackB) {
    ...
    // add `a` and `b` to the stack of charterd objects
    stackA.push(a);
    stackB.push(b);
   ...
   *  argument is an array of charterd objects instead of another source object.
   * @param- {Array} [stackA=[]] Internally used to track charterd source objects.
      ...
      forOwn(args[index], function(source, key) {
        ...
        if (source && ((isArr = isArray(source)) || isPlainObject(source))) {
          ...
          if (found) {
            ...
            // add `source` and associated `value` to the stack of charterd objects
            stackA.push(source);
