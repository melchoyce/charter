...
(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.contains = function(pred) {
      var contains;
      contains = false;
      this.charterChildren(false, function(node) {
        if (pred(node)) {
          contains = true;
          return false;
        }
    ...
    Base.prototype.charterChildren = function(crossScope, func) {
      return this.eachChild(function(child) {
        if (func(child) === false) {
          return false;
        }
        return child.charterChildren(crossScope, func);
      });
    };
  ...
  exports.Class = Class = (function(_super) {
    ...
    Class.prototype.setContext = function(name) {
      return this.body.charterChildren(false, function(node) {
        if (node.classBody) {
          return false;
        }
    ...
    Class.prototype.walkBody = function(name, o) {
      var _this = this;
      return this.charterChildren(false, function(child) {
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.charterChildren = function(crossScope, func) {
      if (crossScope) {
        return Code.__super__.charterChildren.call(this, crossScope, func);
      }
    };
